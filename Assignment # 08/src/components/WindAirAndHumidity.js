        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
            <Hidden smDown>
                <Stack spacing={3} direction='row' justifyContent='flex-end' >
                    ...
                    </SvgIcon><Typography sx={{ color: 'var(--primary)', fontWeight: '500' }} variant='h6' >{apiData.data.clouds.all}%</Typography>
                    </Stack>

                    <Stack spacing={1} direction='row' alignItems='center'> <SvgIcon color='primary' fontSize='medium'><WiStrongWind />
                    </SvgIcon><Typography sx={{ color: 'var(--primary)', fontWeight: '500' }} variant='h6' >{apiData.data.wind.speed}m/s</Typography>
                    </Stack>
