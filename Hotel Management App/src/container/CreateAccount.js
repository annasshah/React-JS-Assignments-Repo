            ...
            >
              ...
              <Stack spacing={2}>
                ...
                <Stack direction='row' alignItems='center' ><FormLabel sx={{ my: 0 }} component="legend">Gender</FormLabel>
                  <RadioGroup row aria-label="gender" name="row-radio-buttons-group" onChange={(e) => setGender(e.target.value)} sx={{ display: 'flex' }}>
                    <Stack direction='row'>
                ...
                <Stack>
                  ...
                  <select onChange={(e)=>setUsercategory(e.target.value)} className="py-3 px-2"  id='usercategory'>
