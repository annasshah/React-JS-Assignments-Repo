                        ...
                        <Grid item xl={6} lg={6} md={6} sm={12} xs={12}>
                                ...
                                >
                                    ...
                                    <Hidden smUp={true} >
                                        <Stack direction='row' sx={{ my: 3, position: 'relative' }} justifyContent='flex-end'>
                                            <Button type='submit' fullWidth sx={{ width: '100%', height: '3rem', color: 'white' }} variant='contained' color='success' size='large'>Next Step</Button>

                                        </Stack>
                                    </Hidden>
                                    <Hidden smDown={true} >
                                        <Stack direction='row' sx={{ my: 3, position: 'relative' }} justifyContent='flex-end'>
                                            <Stack justifyContent='center' alignItems='center'><Button type='submit' sx={{ width: '15rem', height: '3rem', color: 'white' }} variant='contained' color='success' size='large'>Next Step</Button>
                                            </Stack>
                                        </Stack>
                                    </Hidden>
                                </form>
                            ...
                            {paymentMethod && <Stack sx={{ my: 2 }}>
                                ...
                                >
                                    ...
                                    <Hidden smUp={true} >
                                        <Stack direction='row' sx={{ my: 3, position: 'relative' }} justifyContent='flex-end'>
                                            <Button type='submit' fullWidth sx={{ width: '100%', height: '3rem', color: 'white' }} variant={submitLoading ? 'outlined' : 'contained'} color='success' size='large'>{submitLoading ? '' : 'Confirm Booking'}</Button>
                                            {submitLoading ? <Stack sx={{ position: 'absolute' }}> <CircularProgress size={20} disableShrink /></Stack> : null}
                                        </Stack>
                                    </Hidden>
                                    <Hidden smDown={true} >
                                        <Stack direction='row' sx={{ my: 3, position: 'relative' }} justifyContent='flex-end'>
                                            <Stack justifyContent='center' alignItems='center'><Button type='submit' sx={{ width: '15rem', height: '3rem', color: 'white' }} variant={submitLoading ? 'outlined' : 'contained'} color='success' size='large'>{submitLoading ? '' : 'Confirm Booking'}</Button>
                                                {submitLoading ? <Stack sx={{ position: 'absolute' }}> <CircularProgress size={20} disableShrink /></Stack> : null}
                                            </Stack>
                                        </Stack>
                                    </Hidden>
